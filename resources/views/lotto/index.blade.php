            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" id="addLotto" style="display:none">
                            
                            <div class="col-md-12">
                                
                                <a href="{{url('/lotto')}}" id="addButton" class="btn btn-warning"><i class="far fa-window-close"></i> &nbsp; ยกเลิก &nbsp; </a>
                                <form method="post" action="/lotto" autocomplete="off" class="form-horizontal">
                                    <div class="row">

                                        <div class="col-12">
                                            <label class="col-sm-2 col-form-label mt-2" for="lotto_at">{{ __(' งวดวันที่') }}</label>
                                            <div class="col-4">
                                                <input class="form-control" type="text" name="lotto_at" placeholder="16-03-2020" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group text-danger">
                                                    <input class="form-control" type="text" name="lotto1" placeholder="000000" />
                                                </div>
                                            </div>
                                            <label class="col-sm-2 col-form-label mt-2" for="lotto1closeup">{{ __(' รางวัลข้างเคียงรางวัลที่ 1') }}</label>
                                            <div class="col-4">
                                                <div class="form-group text-danger">
                                                    <input class="form-control" type="text" name="lotto1closeup" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group text-danger">
                                                    <textarea class="form-control" name="lotto2" cols="600" rows="2"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group text-danger">
                                                    <textarea class="form-control" name="lotto3" rows="2"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group text-danger">
                                                    <textarea class="form-control" name="lotto4" rows="5"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group text-danger">
                                                    <textarea class="form-control" name="lotto5" rows="9"></textarea>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <label class="col-sm-2 col-form-label mt-2" for="lotto_font3">{{ __(' เลขหน้า 3 ตัว') }}</label>
                                            <div class="col-4">
                                                <div class="form-group text-danger">
                                                    <input class="form-control" type="text" name="lotto_front3" />
                                                </div>
                                            </div>
                                            <label class="col-sm-2 col-form-label mt-2" for="lotto_last3">{{ __(' เลขท้าย 3 ตัว') }}</label>
                                            <div class="col-4">
                                                <div class="form-group text-danger">
                                                    <input class="form-control" type="text" name="lotto_last3" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-2 mt-3 py-3 rounded bg-info">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group text-danger p-0">
                                                        งวดวันที่
                                                        <input class="form-control" type="text" name="lotto_lao_at" placeholder="20-12-2020" />
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group text-danger">
