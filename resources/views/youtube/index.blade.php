                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                @else                    
                                                    ...
                                                    <tr>
                                                        <td>{{$y->id}}</td>
                                                        <td><a href="{{url('youtube/'.$y->id.'/edit')}}" rel="tooltip" title="แก้ไข ( id.{{$y->id}} )">{{$y->title}}</a></td>
                                                        <td>{{creator($y->uid)}}</td>
                                ...
                                <div class="row" id="addBlog" style="display:none;">
                                    <div class="col-md-12">
                                        ...
                                        <form method="POST" action="youtube/" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <label class="col-sm-1 col-form-label mt-2" for="clip">ยูทูป.tdedclub</label>
                                                <div class="col-sm-7">
                                                    <div class="form-group">
                                                        <input class="form-control" name="clip" id="clip" type="text" placeholder="Youtube Url.tdedclub" value="" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <label class="col-sm-1 col-form-label mt-2" for="clip2">ยูทูป.zean7m</label>
                                                <div class="col-sm-7">
                                                    <div class="form-group">
                                                        <input class="form-control" name="clip2" id="clip2" type="text" placeholder="Youtube Url.zean7m" value="" />
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="row">
                                                <label class="col-sm-1 col-form-label mt-2" for="image">รูปภาพ</label>
                                                <div class="col-sm-7">
