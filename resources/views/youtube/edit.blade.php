                            ...
                            <div class="row" id="addBlog">
                                <div class="col-md-12">
                                    ...
                                    <form method="POST" action="{{url('youtube/'.$youtube->id)}}" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <label class="col-sm-1 col-form-label mt-2" for="title">ยูทูป.tdedclub</label>
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <input class="form-control" name="clip" id="clip" type="text" value="{{$youtube->clip}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-sm-1 col-form-label mt-2" for="title">ยูทูป.zean7m</label>
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <input class="form-control" name="clip2" id="clip2" type="text" value="{{$youtube->clip2}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
