          ...
          <form method="post" action="{{ route('user.store') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                <div class="row">
                  <div class="col-md-12 text-right">
                      <a href="{{ route('user.index') }}" class="btn btn-sm btn-primary">{{ __('ย้อนกลับ') }}</a>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('อีเมล') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-password">{{ __(' พาสเวิร์ด') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-password-confirmation">{{ __('ยืนยันพาสเวิร์ด') }}</label>
                  <div class="col-sm-7">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-primary">{{ __('สร้างผู้ใช้งาน') }}</button>
              </div>
            </div>
          </form>
        </div>
